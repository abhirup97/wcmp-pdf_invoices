 ...
 * Override this template by copying it to yourtheme/wcmp-pdf-invoices/wcmp_pdf_invoice_first_template.php
 *
...
<div class="invoice1">
    ...
    <table cellpadding="0" cellspacing="0" class="invoice-detail">
        <tr style="background-color: #252525;">
            ...
            <td align="right">
                <h2><?php _e('INVOICE', 'wcmp-pdf_invoices'); ?></h2>
            </td>
        </tr> 
        <tr style="background-color: #d6d6d6;">
            <td style="padding-top:25px; padding-bottom:25px; border: 0;">
            ...
            <td align="right" style="padding-top:25px; padding-bottom:25px; border: 0;" class="invoice-info">
                <table align="right">
                    <tbody>
